...
export async function PUT(
  ...
  const policy = await prisma.policy.update({
    ...
    data: {
      ...
      ...(data.docType !== undefined && { docType: data.docType === "pdf" ? "pdf" : data.docType === "page" ? "page" : "html" }),
      ...(data.pdfUrl !== undefined && { pdfUrl: typeof data.pdfUrl === "string" && data.pdfUrl ? data.pdfUrl : null }),
      ...(data.pageId !== undefined && { pageId: typeof data.pageId === "string" && data.pageId ? data.pageId : null }),
