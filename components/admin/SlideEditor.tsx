                ...
                <div className="mt-2">
                  ...
                  <div className="alert alert-info small py-2 px-2 mb-2">
                    ...
                    {editBreakpoint === "desktop" ? (
                      ...
                      <>Editing the <strong>mobile</strong> (&lt;768px) layout. An element you haven&apos;t dragged here goes into the automatic centered stack. Elements you positioned on Desktop are stacked in your Desktop top-to-bottom order; an element you never dragged stays right after the element it normally follows (eyebrow, headings, subheading, buttons, images) and moves with it. Drag an element here to give it a real position on mobile instead.</>
                    )}
                  </div>
