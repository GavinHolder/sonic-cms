...
**Override:** Only when user and Codex explicitly agree that a code change is needed and state why.
...
- All `.md`/`.txt` files go in `docs/` (except README.md and AGENTS.md)
